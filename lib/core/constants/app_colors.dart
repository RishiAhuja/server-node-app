...
class AppColors {
  ...
  // Terminal Colors
  static const Color terminalBackground = Color(0xFF1A1A1A);
  static const Color terminalText = Color(0xFF00FF00);
  static const Color terminalCursor = Color(0xFFFFFFFF);
  static const Color terminalPrompt = Color(0xFF00BFFF);
  static const Color terminalError = Color(0xFFFF6B6B);
  static const Color terminalWarning = Color(0xFFFFD93D);
  static const Color terminalInfo = Color(0xFF6BCF7F);
