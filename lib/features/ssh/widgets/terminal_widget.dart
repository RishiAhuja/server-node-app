            ...
            child: Row(
              children: [
                ...
                Obx(() => Container(
                      ...
                      decoration: BoxDecoration(
                        color: controller.connectionStatus.value ==
                  ...
                  children: [
                    ...
                    if (controller.connectionStatus.value ==
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color:
                              AppColors.terminalPrompt.withValues(alpha: 0.1),
                          borderRadius: BorderRadius.circular(4),
                        ),
                        child: Text(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: TextField(
                            ...
                            enabled: controller.connectionStatus.value ==
                                SSHConnectionStatus.connected,
                            style: GoogleFonts.jetBrainsMono(
                              color: AppColors.terminalText,
                              fontSize: AppConstants.terminalFontSize,
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: controller.connectionStatus.value ==
                                      SSHConnectionStatus.connected
                                  ? 'Enter command...'
                        ...
                        CustomButton(
                          text: 'Send',
                          icon: Icons.send,
                          onPressed: controller.connectionStatus.value ==
                                  SSHConnectionStatus.connected
                              ? () {
                                  final command =
